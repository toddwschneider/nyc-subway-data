...
theme_tws = function(base_size = 12, bg_color = "#f4f4f4") {
  ...
  theme_bw(base_size) +
    theme(
      ...
      axis.title.x = element_text(size = rel(1), margin = margin(0.7, 0, 0, 0, unit = "lines")),
...
theme_ridges_tws = function(base_size = 12, ...) {
  theme_ridges(font_size = base_size, font_family = font_family, ...) +
  theme(
    plot.title = element_text(family = title_font_family),
    plot.subtitle = element_text(size = rel(0.7), lineheight = 1),
    plot.caption = element_text(size = rel(0.5), margin = unit(c(1, 0, 0, 0), "lines"), lineheight = 1.1, color = "#555555")
